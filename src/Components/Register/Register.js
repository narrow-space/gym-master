...
const Register = () => {
    const { error, Emailregister, handleEmailChange, handlepasswordchange, handleNameChnage} = Useauth();
                ...
                <div className="col-md-4 mt-5 ">
                    ...
                    <form onSubmit={Emailregister}>
                        <div className="mb-3 input-from">
                            ...
                            <input onChange={handleNameChnage} placeholder="Enter your name" type="text" className="form-control mt-3" required />
